    ...
    function fetchCall(){
      $.ajax({
        ...
        success:function(data){
          ...
          var output = `<button id='acceptcall' style='border-radius:50%;background-color:purple;color:white;padding:3px;float:right' data-id=${data}><i class='fas fa-phone 2x'></i></button>`;
            $('#alert').html(output);
